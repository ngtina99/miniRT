...
/*   Updated: 2024/11/06 21:41:26 by thuy-ngu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//YULIA VERSION WHEN THE CYLINDER WAS IN ONE
...
t_vec3d normalize_vector(t_vec3d v) {
...
//ORIGINAL VERSION IT DIDN'T WORK ON DIFFERENT AXIS
// bool ray_cylinder_intersection(t_cylinder cylinder, t_vec3d ray_origin, t_vec3d ray_direction, t_vec3d *hit_point)
// {
// 	float	radius;
// 	t_vec3d	oc;
...
bool ray_cylinder_top(t_cylinder cylinder, t_vec3d ray_origin, t_vec3d ray_direction, t_vec3d *hit_point)
{
    ...
    float radius;
    float parallel_factor;
    t_vec3d to; // Vector from top to origin
    float t;
    t_vec3d point;
    t_vec3d pt; // Vector from point to top

    // Calculate top center by offsetting cylinder center along the axis
    ...
    to = subtract_vector(top_center, ray_origin); // Vector from ray origin to top center
    ...
    return false; // No intersection with the cap
}
